...
import background from "../../../images/asr.jpg";
...
const Asr = () => {
  return (
    ...
    >
      <div>
        <center>
          <h1>Asr namozini o'qish tartibi</h1>
        </center>
        <p>
          <b style={{ fontSize: "20px" }}>
            {" "}
            Asr namozi 4 rakat farzdan iborat. <br /> <br /> Asr namozi peshin
            namozining farzi bilan bir xil o'qiladi. <br /> Asr namozi
            quyidagicha tartibda o'qiladi:
          </b>
          <br />
          <br />
          1. Niyat qilinadi. <br />
          <b>
            «Alloh rizoligi uchun qibla tomonga yuzlanib, bugungi asr namozining
            to'rt rakat farzini o'qishni niyat qildim»
          </b>
          , deb ko'ngildan o'tkaziladi. <br /> <br />
          2. Iftitoh takbiri aytiladi. <br />
          Erkaklar qo'llari kaftini qiblaga qaratib bosh barmoqlarini quloqning
          yumshoq joyiga tekkazib (Ayollar qo'llarini yelka barobarida ko'tarib
          kaftlarini qiblaga qaratadilar) <b>«Allohu akbar»</b>
          deyishadi.
          <br />
          <br />
          3. Sano duosi o'qiladi. <br />
          <b style={{ fontSize: "25px" }}>SANO DUOSI</b> <br />
          Subhanakallouhumma va bihamdika va tabarokasmuka va taa’la jadduka va
          la ilaha g‘oyruk. <br />
          <br />
          4. Fotiha surasi hamda birorta zam sura o'qiladi.
          <br />
          ...
          <br />
          Zam suraga: <br />
          <b style={{ fontSize: "25px" }}>FALAQ SURASI</b>
          <br />
          ...
          <br />
          5. Ruku qilinadi. <br />
          <b> «Allohu akbar»</b>, deb ruku qilinadi. <br />
          Rukudan <b>«Sami'allohu liman hamidah»</b> deb, Qavma holiga turiladi.{" "}
          <br />
          Qavma holida (tik turganda): <b>
            «Robbana lakal hamd»
          </b> deyiladi. <br />
          <br />
          6. Sajda qilinadi. <br />
          <b>«Allohu akbar»</b> deb avvalo tizzalar, keyin qo'llar, so'ng
          peshona va burun yerga tekkizilib, sajda qilinadi. <br />
          Sajdada uch marta:<b> «Subhana robbiyal a'la»</b> deyiladi. <br />{" "}
          <br />
          7. «Allohu akbar» deb turib, yana Fotiha surasi, zam sura o'qiladi.{" "}
          <br />
          <b style={{ fontSize: "25px" }}>FOTIHA SURASI</b>
          <br />
          A’uzu billahi minash shaytonir rojiym. Bismillahir rohmanir rohiym. Al
          ...
          <br />
          9. Yana sajda qilinadi. <br />
          <b>«Allohu akbar»</b> deb avvalo tizzalar, keyin qo'llar, so'ng
          peshona va burun yerga tekkizilib, sajda qilinadi. <br />
          Sajdada uch marta:<b> «Subhana robbiyal a'la»</b> deyiladi. <br />{" "}
          <br />
          10. O'tirib «Attahiyyat» o'qiladi. <br />
          ...
          <br />
          <br />
          11. «Allohu akbar» deb yana turib, Fotiha surasi va zam sura o'qiladi.{" "}
          <br />
          <b style={{ fontSize: "25px" }}>FOTIHA SURASI</b>
          <br />
          A’uzu billahi minash shaytonir rojiym. Bismillahir rohmanir rohiym. Al
          ...
          <br />
          Zam suraga: <br />
          <b style={{ fontSize: "25px" }}>IXLOS SURASI</b>
          ...
          <br />
          13. Sajda qilinadi. <br />
          <b>«Allohu akbar»</b> deb avvalo tizzalar, keyin qo'llar, so'ng
          peshona va burun yerga tekkizilib, sajda qilinadi. <br />
          Sajdada uch marta:<b> «Subhana robbiyal a'la»</b> deyiladi. <br />{" "}
          <br />
          14. <b>«Allohu akbar»</b> deb to'rtinchi rakatga turiladi va yana
          Fotiha surasi, zam sura o'qiladi. <br />
          <b style={{ fontSize: "25px" }}>FOTIHA SURASI</b>
          <br />
          A’uzu billahi minash shaytonir rojiym. Bismillahir rohmanir rohiym. Al
          hamdulillahi robbil ‘alamiyn. Ar-rohmanir rohiym. Maliki yavmiddiyn.
          ...
          <br />
          16. Sajda qilinadi. <br />
          <b>«Allohu akbar»</b> deb avvalo tizzalar, keyin qo'llar, so'ng
          peshona va burun yerga tekkizilib, sajda qilinadi. <br />
          Sajdada uch marta:<b> «Subhana robbiyal a'la»</b> deyiladi. <br />{" "}
          <br />
          17. O'tirib, <b> «Attahiyyat», «Salovot», «Robbana» </b> duolari
          o'qiladi. <br />
          <b style={{ fontSize: "25px" }}>ATTAHIYYAT DUOSI</b>
          <br />
          Attahiyyatu lillahi vas-solavatu vattoyyibat. Assalamu ‘alayka
          ...
          <br />
          <br />
          18. Salom berib namozdan chiqiladi. <br />
          Avval o'ng, keyin chap yelkaga qarab: <br />
          <b> «Assalamu alaykum va rohmatulloh»</b> deb salom beriladi.
          <br />
          <br />
        </p>
        <AfterNamaz />
